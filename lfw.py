...
# Xing Di, 2017
#
# This code is heavily based on the code from Davi Frossard.                           #
...
if __name__ == '__main__':
    ...
    images,label = load_data(image_path,pair_list)
    ...
    for i in range(len(images)):
        ...
        img1 = cv.imread(idx1)
        img2 = cv.imread(idx2)
        feat1 = sess.run(vgg.fc2, feed_dict={vgg.imgs: [img1]})[0]
        feat2 = sess.run(vgg.fc2, feed_dict={vgg.imgs: [img2]})[0]
        score[i] = 1-spatial.distance.cosine(feat1,feat2)
